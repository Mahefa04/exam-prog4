...
public class SubmissionController {
  ...
  public Submission createSubmission(
    ...
    if (contentType == null || (!contentType.equals("image/png") && !contentType.equals("image/jpeg"))) {
      throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Seuls les formats PNG et JPEG sont acceptés.");
    }
    ...
    emailService.sendEmailWithS3LinkAsync(savedSubmission.getEmail(), savedSubmission.getFile_name());
